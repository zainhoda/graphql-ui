...
var $author$project$Main$configDecoder = A2(
...
var $author$project$Main$getConfig = function (configURL) {
	return $elm$http$Http$get(
		{
			expect: A2($elm$http$Http$expectJson, $author$project$Main$GotConfig, $author$project$Main$configDecoder),
			url: configURL
		});
};
