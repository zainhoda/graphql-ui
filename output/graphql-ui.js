...
var $author$project$Main$view = function (model) {
	return $elm$html$Html$text(model.E);
};
var $author$project$Main$main = $elm$browser$Browser$element(
	{au: $author$project$Main$init, aA: $author$project$Main$subscriptions, aC: $author$project$Main$update, aD: $author$project$Main$view});
